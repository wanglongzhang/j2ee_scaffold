...
CREATE TABLE `role` (
  ...
  `status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '1' COMMENT '是否有效  1有效  2无效',
  PRIMARY KEY (`id`)
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('10003', 'admin', '12222222222', '123456', '超级用户23', '4610', '1', '2017-10-30 11:52:38', '2018-06-14 13:00:00', '1');
INSERT INTO `user` VALUES ('10004', 'user', '13333333333', '123456', '莎士比亚', '4620', '2', '2017-10-30 16:13:02', '2018-06-14 13:00:00', '1');
INSERT INTO `user` VALUES ('10005', 'aaa', '18768128888', '123456', 'abba', '4653', '1', '2017-11-15 14:02:56', '2018-06-14 13:00:00', '1');
INSERT INTO `user` VALUES ('10007', 'test', '18768128889', '123456', '就看看列表', '4576', '3', '2017-11-22 16:29:41', '2018-06-14 13:00:00', '1');
...
CREATE TABLE `user_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_fk` (`user_id`),
  CONSTRAINT `role_fk` FOREIGN KEY (`user_id`) REFERENCES `role` (`id`),
